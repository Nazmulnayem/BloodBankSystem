...
namespace B_B_FINAL_EVE.Controllers
{
    public class RequisitionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Reg_ID,Name,Group_ID,District_ID,Thana_ID,ContactNumber,Email,Reg_Date,Status,Message")] Requisition requisition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Reg_ID,Name,Group_ID,District_ID,Thana_ID,ContactNumber,Email,Reg_Date,Status,Message")] Requisition requisition)
        {
            if (ModelState.IsValid)
            {
